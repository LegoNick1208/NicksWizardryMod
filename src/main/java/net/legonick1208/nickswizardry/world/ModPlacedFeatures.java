...
//    public static final RegistryKey<PlacedFeature> TestTreePlacedKey = registerKey("test-tree-placed");
...
//                VegetationPlacedFeatures.modifiersWithWouldSurvive(PlacedFeatures.createCountExtraModifier(1, 0.1f, 2), ModBlocks.TestSapling));
    ...
    public static RegistryKey<PlacedFeature> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.PLACED_FEATURE, new Identifier(NicksWizardryMod.MOD_ID, name));
    }
